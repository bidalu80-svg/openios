    ...
    private func inputFieldArea(vm: ChatViewModel) -> some View {
        ...
        VStack(spacing: 0) {
            ...
            ChatInputField(
                ...
                openAIFileSearchEnabled: $vm.openAIFileSearchEnabled,
                openAIMCPEnabled: $vm.openAIMCPEnabled,
                openAIToolSearchEnabled: $vm.openAIToolSearchEnabled,
                ...
                isOpenAINativeToolsAvailable: viewModel.isOpenAIResponsesNativeToolsAvailable,
